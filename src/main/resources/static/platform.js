 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/, Ya = [/\/amp\//, /\/amp$/, /^\/amp$/], Za = /^[a-zA-Z0-9\-_\.,!]+$/,
        $a = /^gapi\.loaded_[0-9]+$/, ab = /^[a-zA-Z0-9,._-]+$/, eb = function (a, b, c, d) {
            ...
            return [encodeURIComponent(a.Z).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.L ? "/am=" + e(a.L) : "", a.T ? "/rs=" + e(a.T) : "", a.V ? "/t=" + e(a.V) : "", "/cb=", e(c)].join("")
        }, fb = function (a) {
            ...
            e = ib(a, "rs");
            a = ib(a, "t");
            return {Z: b, version: c, L: d, T: e, V: a}
        }, gb = function (a) {
    ...
    var Nd = function (a) {
        ...
        d = "E" === c && e.i;
        return !d && ("U" !== c || e.i) || d && !Jd ? b : {P: !0, i: d, ca: a.substr(1), domain: e.domain, l: e.l}
    }, Od = function (a) {
        if (!a) return [];
        a = a.split("=");
        ...
        if (null !== a) {
            ...
            if (c) {
                var d = Pd(c), e = d && d.ba[Number(a)];
                d = d && d.clientId;
                if (e) return {D: a, aa: e, clientId: d}
            }
        }
        return null
    };
    ...
    var Rd = function () {
        var a = Qd(), b = a && a.aa || null, c = a && a.clientId;
        L("auth", {
            callback: function () {
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.cs.1AVzLbr60rk.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMPc7qb11E0ck1coPm9Z0Leu3qL8w",
            "u": "https://apis.google.com/js/platform.js",
            "hee": true,
            "fp": "ea2c19684f4ee3c248001b50812e0af41b3b2551",
            "dpo": false
        },
